...
class CouponRequest extends StatefulWidget {
  const CouponRequest({Key? key}) : super(key: key);

  @override
  State<CouponRequest> createState() => _CouponRequestState();
}
                              ...
                              onPressed: () async {
                                if (_formKey.currentState!.validate()) {
                                  ...
                                  _formData['date'] = DateFormat('yyyy-MM-dd')
                                      .format(_operationDate);
                                  await createRequest(context, _formData);
                                }
                              },
                              child: const Padding(
